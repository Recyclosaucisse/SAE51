...
// APPEUI ligne 70 : 0C 7E 45 01 02 03 03 45
static const u1_t PROGMEM APPEUI[8]={ 0x0C, 0x7E, 0x45, 0x01, 0x02, 0x03, 0x03, 0x45  }; // 8 octets  
void os_getArtEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// DEVEUI -> APPEUI in little Indian
static const u1_t PROGMEM DEVEUI[8]={ 0x45, 0x03, 0x03, 0x02, 0x01, 0x45, 0x7E, 0x0C }; 
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

//APPKEY Ligne 69 : 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 03 45
static const u1_t PROGMEM APPKEY[16] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x03, 0x45 }; //16 octets
