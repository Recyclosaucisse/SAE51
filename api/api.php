...
// Function to verify the values from the POST request
function verifyValues()
{
    ...
    // Check if the value of the luminosity is correct
    ...
    if ($values[2] !== "ALLUMER-LUMIERE" && $values[2] !== "ETEINDRE-LUMIERE" && $values[2] !== "") {
        http_response_code(400);
        echo "La troisième valeur doit être 'ALLUMER-LUMIERE' ou 'ETEINDRE-LUMIERE' ou ''.";
        exit;
    }
